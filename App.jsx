...
// --- DATABASE: High-Res Verified CDN Images ---
const fragrances = [
  ...
  { id: 2, type: "Designer", name: "Le Male Elixir", brand: "JPG", image: "https://fimgs.net/mdimg/perfume/m.79355.jpg", topNotes: ["Mint"], middleNotes: ["Honey"], baseNotes: ["Tobacco"], dupe: { name: "Ramz Silver", brand: "Lattafa", price: "22 CHF" }},
  { id: 13, type: "Arabian", name: "Khamrah", brand: "Lattafa", image: "https://fimgs.net/mdimg/perfume/m.75831.jpg", topNotes: ["Cinnamon"], middleNotes: ["Dates"], baseNotes: ["Vanilla"], dupe: { name: "Angel's Share Alt", brand: "Lattafa", price: "45 CHF" }},
  ...
  { id: 6, type: "Niche", name: "Aventus", brand: "Creed", image: "https://fimgs.net/mdimg/perfume/m.9828.jpg", topNotes: ["Pineapple"], middleNotes: ["Birch"], baseNotes: ["Musk"], dupe: { name: "CDNIM", brand: "Armaf", price: "35 CHF" }},
  ...
  { id: 9, type: "Niche", name: "Angels' Share", brand: "Kilian", image: "https://fimgs.net/mdimg/perfume/m.62615.jpg", topNotes: ["Cognac"], middleNotes: ["Cinnamon"], baseNotes: ["Praline"], dupe: { name: "Khamrah", brand: "Lattafa", price: "42 CHF" }},
  ...
  { id: 4, type: "Designer", name: "MYSLF", brand: "YSL", image: "https://fimgs.net/mdimg/perfume/m.84074.jpg", topNotes: ["Bergamot"], middleNotes: ["Orange Blossom"], baseNotes: ["Patchouli"], dupe: { name: "Sheikh Al Shuyukh", brand: "Lattafa", price: "25 CHF" }},
...
const creators = [
  ...
  { id: "jeremy", name: "Jeremy Fragrance", profileImg: "https://fimgs.net/mdimg/perfume/m.1.jpg", icon: <Crown size={20}/>, tagline: "POWER.", desc: "The global authority on performance and compliments. Jeremy's philosophy is rooted in sillage and the social impact of scent." },
  { id: "cologneboy", name: "TheCologneBoy", profileImg: "https://fimgs.net/mdimg/perfume/m.2.jpg", icon: <Zap size={20}/>, tagline: "MODERN ESSENTIALS.", desc: "The pulse of the new generation. Identifying trending 'bangers' and high-value fragrances that punch above their price point." }
];
              ...
              <div className="flex-1 bg-white/[0.02] border border-white/5 p-16 relative overflow-hidden min-h-[400px]">
                <AnimatePresence mode="wait"><motion.div key={selCreatorId} initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }}>
                  <div className="flex items-center gap-8 mb-10">
                    <img src={currentCreator.profileImg} className="w-20 h-20 rounded-full border border-amber-500/40 object-cover" />
