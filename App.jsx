...
const fragrances = [
  ...
  // Data continues for all 100 entries following this structure...
];
        ...
        <AnimatePresence mode="wait">
          {activeTab === 'archive' ? (
            ...
            <div className="max-w-2xl mx-auto py-20 text-center">
              <h2 className="text-2xl font-black uppercase tracking-widest mb-4">Market News</h2>
              <p className="text-gray-500">Live feed for the Swiss market currently updating.</p>
            </div>
          )}
        </AnimatePresence>
      </main>
      ...
      <AnimatePresence>
        {selected && (
          <div className="fixed inset-0 z-[200] flex items-center justify-center p-6 bg-black/90 backdrop-blur-xl">
            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.95 }} className="bg-[#0c0c0c] border border-white/10 w-full max-w-xl rounded-[3rem] overflow-hidden shadow-2xl relative">
              ...
              <div className="p-12 space-y-10">
                ...
                <div className="grid grid-cols-2 gap-3 pt-4">
                  ...
                  <div className="bg-white/[0.03] p-5 rounded-[2rem] border border-white/5">
                    ...
                    <span className="text-[8px] text-gray-500 uppercase font-black block">Value Dupe</span>
